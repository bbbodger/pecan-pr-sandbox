...
Once the settings have been read and prepared, it is often useful to inspect the structure of the `settings` object. This object is the R list that we just created from the `pecan.xml` file; it contains parameters and configurations for the PEcAn workflow. 
