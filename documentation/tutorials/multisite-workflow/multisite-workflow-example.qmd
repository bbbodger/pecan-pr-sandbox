...
## You can either use this tibble for running demo , or can also use the site_info_example.csv in the document/tutorial/multisite-workflow/site_info_example.csv
...
## Shows settings object after "createMultiSiteSettings(settings, selected_sites)"
